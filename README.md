...
[![Release v33.6.0](https://img.shields.io/badge/release-v33.6.0_Stage--1--Full_Honest_Closure-brightgreen)](https://github.com/fajarkraton/fajar-lang/releases/tag/v33.6.0)
...
| Metric | Value |
|--------|-------|
| Release | **v33.6.0 "Stage-1-Full Honest Closure"** (2026-05-05) — closes all v33.5.0 `❌ honest-scope` items per "perfection-over-time" rule: R8 cross-fn calls, while loops, string/float/bool literals, struct/enum decls. Test suite 8 → 17 (P9-P17 NEW), all PASS in 0.15s. Includes factorial via cross-fn+while-loop combo (P14: `fact(5)=120`). Cumulative ~6h vs plan 5-15d. Source: `docs/SELFHOST_FJ_PHASE_{0..9}_FINDINGS.md`. |
