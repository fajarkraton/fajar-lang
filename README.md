...
[![Release v33.4.0](https://img.shields.io/badge/release-v33.4.0_Stage--1--Subset_Self--Hosting-brightgreen)](https://github.com/fajarkraton/fajar-lang/releases/tag/v33.4.0)
...
| Metric | Value |
|--------|-------|
| Release | **v33.4.0 "Stage-1-Subset Self-Hosting"** (2026-05-05) — fj-lang now self-hosts at Stage-1-Subset level. stdlib/lexer.fj + stdlib/analyzer.fj + stdlib/codegen.fj compose into a working bootstrap chain that compiles subset fj programs to native binaries via gcc. 5/5 E2E tests PASS in 0.05s. Cumulative ~3h vs plan 5-10d (-99%). Predecessor v33.3.0: FajarQuant Algorithm 100% Fajar Lang (7 modules ported). Source: `docs/SELFHOST_FJ_PHASE_{0..6}_FINDINGS.md`. |
