//! Hosted (libc-backed) Cranelift runtime declarations shared by the JIT
//! (`CraneliftCompiler`) and AOT (`ObjectCompiler`) backends.
//!
//! Historically each backend carried its own near-identical
//! `declare_runtime_functions` body (~4.2K + ~3.6K lines, ~98% overlap).
//! Both are now thin wrappers over [`declare_hosted_runtime`]; the AOT
//! declaration stream is an exact ordered subsequence of the JIT stream,
//! reproduced by skipping the `jit_extras` blocks.
...
use super::super::types as clif_types;

/// Declares every hosted runtime function into `module` and records its
/// `FuncId` in `functions` under the interpreter-visible builtin key.
///
/// * `jit_extras` — also declare the JIT-only groups (str_rev, waker,
///   thread pool, join handles, async channels, streams, SIMD, ONNX).
///   The AOT object backend links against the static runtime and does not
///   ship these.
/// * `profiling` — declare `fj_rt_profile_enter`/`fj_rt_profile_exit`
///   (JIT `--profile` instrumentation).
pub(super) fn declare_hosted_runtime<M: Module>(
    module: &mut M,
    ...
    functions.insert("println".to_string(), println_id);
    ...
    let print_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("print".to_string(), print_id);
    ...
    let println_str_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__println_str".to_string(), println_str_id);
    ...
    let print_str_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__print_str".to_string(), print_str_id);
    ...
    let println_f64_id = module
        .declare_function("fj_rt_println_f64", Linkage::Import, &sig_println_f64)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__println_f64".to_string(), println_f64_id);
    ...
    let print_f64_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__print_f64".to_string(), print_f64_id);
    ...
    let parse_int_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__parse_int".to_string(), parse_int_id);
    let parse_float_id = module
        .declare_function("fj_rt_parse_float", Linkage::Import, &sig_parse)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__parse_float".to_string(), parse_float_id);
    ...
    let int_to_str_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__int_to_string".to_string(), int_to_str_id);
    ...
    let float_to_str_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__float_to_string".to_string(), float_to_str_id);
    ...
    let alloc_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__alloc".to_string(), alloc_id);
    ...
    let free_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__free".to_string(), free_id);
    ...
    let reset_alloc_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__reset_global_allocator".to_string(), reset_alloc_id);
    ...
    let concat_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_concat".to_string(), concat_id);
    ...
    let arr_new_id = module
        .declare_function("fj_rt_array_new", Linkage::Import, &sig_arr_new)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_new".to_string(), arr_new_id);
    ...
    let arr_push_id = module
        .declare_function("fj_rt_array_push", Linkage::Import, &sig_arr_push)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_push".to_string(), arr_push_id);
    ...
    let arr_get_id = module
        .declare_function("fj_rt_array_get", Linkage::Import, &sig_arr_get)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_get".to_string(), arr_get_id);
    ...
    let arr_set_id = module
        .declare_function("fj_rt_array_set", Linkage::Import, &sig_arr_set)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_set".to_string(), arr_set_id);
    ...
    let arr_len_id = module
        .declare_function("fj_rt_array_len", Linkage::Import, &sig_arr_len)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_len".to_string(), arr_len_id);
    ...
    let arr_pop_id = module
        .declare_function("fj_rt_array_pop", Linkage::Import, &sig_arr_pop)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_pop".to_string(), arr_pop_id);
    ...
    let arr_free_id = module
        .declare_function("fj_rt_array_free", Linkage::Import, &sig_arr_free)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_free".to_string(), arr_free_id);
    ...
    let arr_contains_id = module
        .declare_function("fj_rt_array_contains", Linkage::Import, &sig_arr_contains)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_contains".to_string(), arr_contains_id);
    ...
    let arr_is_empty_id = module
        .declare_function("fj_rt_array_is_empty", Linkage::Import, &sig_arr_check)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_is_empty".to_string(), arr_is_empty_id);

    // fj_rt_array_reverse(arr: ptr) -> i64
    let arr_reverse_id = module
        .declare_function("fj_rt_array_reverse", Linkage::Import, &sig_arr_check)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_reverse".to_string(), arr_reverse_id);
    ...
    let str_contains_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_contains".to_string(), str_contains_id);
    ...
    let str_replace_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_replace".to_string(), str_replace_id);
    ...
    let str_sub_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_substring".to_string(), str_sub_id);
    ...
    let str_index_of_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_index_of".to_string(), str_index_of_id);
    ...
    let str_repeat_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_repeat".to_string(), str_repeat_id);
    ...
    let str_chars_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_chars".to_string(), str_chars_id);

    // fj_rt_str_bytes — same signature as chars
    let str_bytes_id = module
        .declare_function("fj_rt_str_bytes", Linkage::Import, &sig_str_to_arr)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_bytes".to_string(), str_bytes_id);
    ...
    let arr_join_id = module
        .declare_function("fj_rt_array_join", Linkage::Import, &sig_arr_join)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__array_join".to_string(), arr_join_id);
    ...
    let str_split_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__str_split".to_string(), str_split_id);
    ...
    let split_len_id = module
        .declare_function("fj_rt_split_len", Linkage::Import, &sig_split_len)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__split_len".to_string(), split_len_id);
    ...
    let split_get_id = module
        .declare_function("fj_rt_split_get", Linkage::Import, &sig_split_get)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__split_get".to_string(), split_get_id);
    ...
    let format_id = module
        .declare_function("fj_rt_format", Linkage::Import, &sig_format)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__format".to_string(), format_id);
    ...
    for (rt_name, fn_name) in &[
        ...
        let fid = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert(fn_name.to_string(), fid);
    }
    ...
    let pow_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__math_pow".to_string(), pow_id);
    ...
    let write_file_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__write_file".to_string(), write_file_id);
    ...
    let read_file_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__read_file".to_string(), read_file_id);

    // fj_rt_append_file — same sig as write_file
    let append_file_id = module
        .declare_function("fj_rt_append_file", Linkage::Import, &sig_write_file)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__append_file".to_string(), append_file_id);
    ...
    // Reuse sig_file_exists for (ptr, i64) -> i64 patterns
    {
        ...
        for (rt, local) in [
            ...
            let id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert(local.to_string(), id);
        }

        // (i64) -> void for free
        let mut sig_1i_v = module.make_signature();
        sig_1i_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(ity));
        let free_id = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert("__async_io_free".to_string(), free_id);
    }
    ...
    let map_new_id = module
        .declare_function("fj_rt_map_new", Linkage::Import, &sig_map_new)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_new".to_string(), map_new_id);
    ...
    let map_insert_int_id = module
        .declare_function("fj_rt_map_insert_int", Linkage::Import, &sig_map_insert)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_insert_int".to_string(), map_insert_int_id);
    ...
    let map_insert_float_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_insert_float".to_string(), map_insert_float_id);
    ...
    let map_insert_str_id = module
        .declare_function("fj_rt_map_insert_str", Linkage::Import, &sig_map_insert_str)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_insert_str".to_string(), map_insert_str_id);
    ...
    let map_get_int_id = module
        .declare_function("fj_rt_map_get_int", Linkage::Import, &sig_map_get)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_get_int".to_string(), map_get_int_id);
    ...
    let map_len_id = module
        .declare_function("fj_rt_map_len", Linkage::Import, &sig_map_len)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__map_len".to_string(), map_len_id);
    ...
    // fj_rt_map_keys(map, count_out) -> ptr  — Signature: (i64, i64) -> i64
    {
        ...
        let keys_id = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert("__map_keys".to_string(), keys_id);
    }

    // fj_rt_map_values(map) -> heap_array_ptr  — Signature: (i64) -> i64
    {
        let i64_t = clif_types::default_int_type();
        let mut sig_map_values = module.make_signature();
        sig_map_values
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_map_values
        ...
        let values_id = module
            .declare_function("fj_rt_map_values", Linkage::Import, &sig_map_values)
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert("__map_values".to_string(), values_id);
    }

    // ── Thread primitives ────────────────────────────────────────────

    // fj_rt_thread_spawn(fn_ptr, arg) -> handle_ptr
    let mut sig_thread_spawn = module.make_signature();
    sig_thread_spawn
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::pointer_type(),
    ...
    let thread_spawn_id = module
        .declare_function("fj_rt_thread_spawn", Linkage::Import, &sig_thread_spawn)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__thread_spawn".to_string(), thread_spawn_id);

    // fj_rt_thread_spawn_noarg(fn_ptr) -> handle_ptr
    let mut sig_thread_spawn_noarg = module.make_signature();
    ...
    let thread_spawn_noarg_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__thread_spawn_noarg".to_string(), thread_spawn_noarg_id);

    // fj_rt_thread_join(handle) -> i64
    let mut sig_thread_join = module.make_signature();
    sig_thread_join
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::pointer_type(),
    ...
    let thread_join_id = module
        .declare_function("fj_rt_thread_join", Linkage::Import, &sig_thread_join)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__thread_join".to_string(), thread_join_id);

    // fj_rt_thread_is_finished(handle) -> i64
    let thread_is_finished_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__thread_is_finished".to_string(), thread_is_finished_id);

    // fj_rt_tls_set(key: i64, value: i64) -> void
    let mut sig_tls_set = module.make_signature();
    sig_tls_set
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::default_int_type(),
    ...
    let tls_set_id = module
        .declare_function("fj_rt_tls_set", Linkage::Import, &sig_tls_set)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tls_set".to_string(), tls_set_id);

    // fj_rt_tls_get(key: i64) -> i64
    let mut sig_tls_get = module.make_signature();
    sig_tls_get
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::default_int_type(),
    ...
    let channel_select2_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__channel_select2".to_string(), channel_select2_id);
    ...
    let mut sig_bounded_new = module.make_signature();
    sig_bounded_new
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::default_int_type(),
    ...
    let bounded_send_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__channel_bounded_send".to_string(), bounded_send_id);

    // fj_rt_channel_bounded_recv(handle) -> i64 (same sig as thread_join)
    let bounded_recv_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__channel_bounded_recv".to_string(), bounded_recv_id);

    // fj_rt_channel_try_send(handle, value) -> i64 (ptr, i64 -> i64)
    let mut sig_try_send = module.make_signature();
    sig_try_send
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::pointer_type(),
    ...
    let bounded_free_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__channel_bounded_free".to_string(), bounded_free_id);

    // ── Atomic primitives ────────────────────────────────────────────

    // fj_rt_atomic_new(initial: i64) -> *mut u8
    let mut sig_atomic_new = module.make_signature();
    sig_atomic_new
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::default_int_type(),
    ...
    let atomic_load_relaxed_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__atomic_load_relaxed".to_string(), atomic_load_relaxed_id);

    let atomic_load_acquire_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__atomic_load_acquire".to_string(), atomic_load_acquire_id);

    let atomic_store_relaxed_id = module
        .declare_function(
    ...
    let atomic_store_release_id = module
        .declare_function(
    ...
    let mut sig_atomic_add = module.make_signature();
    sig_atomic_add
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            clif_types::pointer_type(),
    ...
    // ── Closure handles (S2.6) ──────────────────────────────────────
    {
        ...
        // (i64, i64) -> i64
        let mut sig_2i_i = module.make_signature();
        ...
        // (i64, i64, i64) -> void
        let mut sig_3i_v = module.make_signature();
        ...
        let mut sig_3i_i = module.make_signature();
        ...
        sig_3i_i.returns.push(AP::new(int_ty));
        {
            let id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__closure_call_2".to_string(), id);
        }
    ...
    let volatile_read_id = module
        .declare_function("fj_rt_volatile_read", Linkage::Import, &sig_volatile_read)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__volatile_read".to_string(), volatile_read_id);

    // fj_rt_volatile_write(addr: *mut i64, value: i64) -> void
    let mut sig_volatile_write = module.make_signature();
    sig_volatile_write
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            cranelift_codegen::ir::types::I64,
    ...
    let volatile_write_id = module
        .declare_function("fj_rt_volatile_write", Linkage::Import, &sig_volatile_write)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__volatile_write".to_string(), volatile_write_id);
    ...
    for (suffix, internal) in &[
        ...
        let id = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert(internal.to_string(), id);
    }
    ...
    for name in &[
        ...
        let id = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert(format!("__{name}"), id);
    }
    ...
    let sig_void_void = module.make_signature();
    let compiler_fence_id = module
        .declare_function("fj_rt_compiler_fence", Linkage::Import, &sig_void_void)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__compiler_fence".to_string(), compiler_fence_id);

    // fj_rt_memory_fence() -> void
    let memory_fence_id = module
        .declare_function("fj_rt_memory_fence", Linkage::Import, &sig_void_void)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__memory_fence".to_string(), memory_fence_id);

    // ── Memory access primitives ─────────────────────────────────────

    // fj_rt_mem_read(ptr: *const u8, offset: i64) -> i64
    let mut sig_mem_read = module.make_signature();
    sig_mem_read
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            cranelift_codegen::ir::types::I64,
    ...
    let mem_read_id = module
        .declare_function("fj_rt_mem_read", Linkage::Import, &sig_mem_read)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__mem_read".to_string(), mem_read_id);

    // fj_rt_mem_write(ptr: *mut u8, offset: i64, value: i64) -> void
    let mut sig_mem_write = module.make_signature();
    sig_mem_write
        .params
        .push(cranelift_codegen::ir::AbiParam::new(
            cranelift_codegen::ir::types::I64,
    ...
    let mem_write_id = module
        .declare_function("fj_rt_mem_write", Linkage::Import, &sig_mem_write)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__mem_write".to_string(), mem_write_id);
...

    {
        ...
        // Signature: (i64) -> i64
        let mut sig_i_i = module.make_signature();
        sig_i_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_i_i
        ...
        let mut sig_ii_i_alloc = module.make_signature();
        sig_ii_i_alloc
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_ii_i_alloc
        ...
        // Signature: (i64) -> void
        let mut sig_i_v = module.make_signature();
        sig_i_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));

        // Signature: (i64, i64) -> void
        let mut sig_ii_v = module.make_signature();
        sig_ii_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_ii_v
        ...
        let mut sig_iii_v = module.make_signature();
        sig_iii_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_iii_v
        ...
        for (rt_name, key, sig) in [
            ...
            let id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert(key.to_string(), id);
        }
        for (rt_name, key) in [
        ...
        }
        {
            let id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__freelist_free".to_string(), id);
        }
        {
            let id = module
                .declare_function("fj_rt_freelist_destroy", Linkage::Import, &sig_i_v)
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__freelist_destroy".to_string(), id);
        }
...

    {
        ...
        // Signature: () -> i64
        let mut sig_v_i = module.make_signature();
        sig_v_i
            .returns
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));

        // Signature: (i64) -> i64
        let mut sig_fi_i = module.make_signature();
        sig_fi_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_fi_i
        ...
        // Signature: (i64) -> void
        let mut sig_fi_v = module.make_signature();
        sig_fi_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));

        // Signature: (i64, i64) -> void
        let mut sig_fii_v = module.make_signature();
        sig_fii_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_fii_v
        ...
        // Signature: (i64, i64) -> i64
        let mut sig_fii_i = module.make_signature();
        sig_fii_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_fii_i
        ...
        // Signature: (i64, i64, i64) -> void
        let mut sig_fiii_v = module.make_signature();
        sig_fiii_v
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_t));
        sig_fiii_v
        ...
        }
        {
            let id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__future_save_local".to_string(), id);
        }
        ...
        }
        {
            let fn_id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__timer_free".to_string(), fn_id);
        }
        {
            // timer_schedule(timer, millis, waker) -> i64
            let mut sig_timer_sched = module.make_signature();
            sig_timer_sched
                .params
                .push(cranelift_codegen::ir::AbiParam::new(i64_t));
            sig_timer_sched
            ...
            let fn_id = module
                ...
                .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
            functions.insert("__timer_schedule".to_string(), fn_id);
        }
        ...
        if jit_extras {
            ...
            }
            {
                let fn_id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__threadpool_free".to_string(), fn_id);
            }
            // threadpool_spawn_join(pool, future) -> joinhandle_ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__threadpool_spawn_join".to_string(), id);
            }
            ...
            // joinhandle_new() -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__joinhandle_new".to_string(), id);
            }
            ...
            // joinhandle_set_result(ptr, value) -> void
            {
                ...
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__joinhandle_set_result".to_string(), id);
            }
            ...
            // async_channel_new() -> ptr, async_channel_bounded(cap) -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__async_channel_new".to_string(), id);
            }
            {
                let id = module
                    .declare_function("fj_rt_async_channel_bounded", Linkage::Import, &sig_fi_i)
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__async_channel_bounded".to_string(), id);
            }
            ...
            // stream_new() -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__stream_new".to_string(), id);
            }
            // stream_from_range(start, end) -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__stream_from_range".to_string(), id);
            }
            ...
            // stream_push(ptr, val) -> void
            {
                ...
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__stream_push".to_string(), id);
            }
            ...
            // stream_take(ptr, n) -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__stream_take".to_string(), id);
            }
        }
    }
    ...
    if jit_extras {
        // ── SIMD runtime ────────────────────────────────────────────────
        {
            ...
            // () -> ptr  [f32x4_zeros]
            let mut sig_simd_v_p = module.make_signature();
            sig_simd_v_p
                .returns
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));

            // (i64) -> ptr  [splat]
            let mut sig_simd_i_p = module.make_signature();
            sig_simd_i_p
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_simd_i_p
            ...
            // (ptr) -> void  [free]
            let mut sig_simd_p_v = module.make_signature();
            sig_simd_p_v
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));

            // (ptr, i64) -> i64  [get]
            let mut sig_simd_pi_i = module.make_signature();
            sig_simd_pi_i
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_simd_pi_i
            ...
            let mut sig_simd_pp_p = module.make_signature();
            sig_simd_pp_p
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_simd_pp_p
            ...
            // (ptr) -> i64  [sum, min, max]
            let mut sig_simd_p_i = module.make_signature();
            sig_simd_p_i
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_simd_p_i
            ...
            let mut sig_simd_4i_p = module.make_signature();
            for _ in 0..4 {
                sig_simd_4i_p
                    .params
                    .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            ...
            let mut sig_simd_ppi_v = module.make_signature();
            sig_simd_ppi_v
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_simd_ppi_v
            ...
            // f32x4_new(a, b, c, d) -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__simd_f32x4_new".to_string(), id);
            }
            // f32x4_store(vec, arr, offset) -> void
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__simd_f32x4_store".to_string(), id);
            }
            ...
            // i32x4_new(a, b, c, d) -> ptr
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__simd_i32x4_new".to_string(), id);
            }
            // i32x4_store(vec, arr, offset) -> void
            {
                let id = module
                    ...
                    .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
                functions.insert("__simd_i32x4_store".to_string(), id);
            }
        ...
        // ── ONNX runtime ────────────────────────────────────────────────
        {
            ...
            // () -> ptr  [onnx_new]
            let mut sig_onnx_v_p = module.make_signature();
            sig_onnx_v_p
                .returns
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));

            // (ptr) -> void  [onnx_free]
            let mut sig_onnx_p_v = module.make_signature();
            sig_onnx_p_v
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));

            // (ptr) -> i64  [node_count, initializer_count]
            let mut sig_onnx_p_i = module.make_signature();
            sig_onnx_p_i
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_onnx_p_i
            ...
            let mut sig_onnx_pi_v = module.make_signature();
            sig_onnx_pi_v
                .params
                .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            sig_onnx_pi_v
            ...
            let mut sig_onnx_pii_v = module.make_signature();
            for _ in 0..3 {
                sig_onnx_pii_v
                    .params
                    .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            ...
            let mut sig_onnx_pppi_v = module.make_signature();
            for _ in 0..4 {
                sig_onnx_pppi_v
                    .params
                    .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            ...
            let mut sig_onnx_5i_v = module.make_signature();
            for _ in 0..5 {
                sig_onnx_5i_v
                    .params
                    .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
            ...
            let mut sig_onnx_ppi_i = module.make_signature();
            for _ in 0..3 {
                sig_onnx_ppi_i
                    .params
                    .push(cranelift_codegen::ir::AbiParam::new(ptr_ty));
    ...
    // ── Mixed precision runtime ──────────────────────────────────────
    {
        ...
        let mut sig_if_i = module.make_signature();
        sig_if_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
        sig_if_i
        ...
        let qid = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert("__tensor_quantize_int8".to_string(), qid);

        // quant_scale / quant_zero_point: () -> f64
        let mut sig_void_f = module.make_signature();
        sig_void_f
            .returns
            .push(cranelift_codegen::ir::AbiParam::new(f64_ty));
        for (rt_name, key) in [
        ...
        let mut sig_iff_i = module.make_signature();
        sig_iff_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
        sig_iff_i
        ...
        let dqid = module
            ...
            .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
        functions.insert("__tensor_dequantize_int8".to_string(), dqid);
    }
    ...
    // ── Distributed training runtime ─────────────────────────────────
    {
        ...
        // (i64, i64) -> i64
        let mut sig_ii_i = module.make_signature();
        sig_ii_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
        sig_ii_i
        ...
        // (i64, i64, i64) -> i64
        let mut sig_iii_i = module.make_signature();
        sig_iii_i
            .params
            .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
        sig_iii_i
    ...
    sig_iii_i
        .returns
        .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
    let tensor_get_id = module
        .declare_function("fj_rt_tensor_get", Linkage::Import, &sig_iii_i)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_get".to_string(), tensor_get_id);

    let tensor_reshape_id = module
        .declare_function("fj_rt_tensor_reshape", Linkage::Import, &sig_iii_i)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_reshape".to_string(), tensor_reshape_id);

    // (i64, i64, i64, i64) -> void  [set]
    let mut sig_iiii = module.make_signature();
    sig_iiii
        .params
        .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
    sig_iiii
    ...
    let requires_grad_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_requires_grad".to_string(), requires_grad_id);

    // mse_loss(ptr, ptr) -> i64 — reuse sig_condvar_wait
    let mse_loss_id = module
        .declare_function("fj_rt_mse_loss", Linkage::Import, &sig_condvar_wait)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__mse_loss".to_string(), mse_loss_id);

    // cross_entropy_loss(ptr, ptr) -> i64 — reuse sig_condvar_wait
    let cross_entropy_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__cross_entropy_loss".to_string(), cross_entropy_id);

    // tensor_grad(ptr) -> ptr — reuse sig_thread_spawn_noarg
    let tensor_grad_id = module
        .declare_function(
            "fj_rt_tensor_grad",
            Linkage::Import,
            &sig_thread_spawn_noarg,
    ...
    let grad_data_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__grad_tensor_data".to_string(), grad_data_id);

    // grad_tensor_free(ptr) -> void — reuse sig_map_clear
    let grad_free_id = module
        .declare_function("fj_rt_grad_tensor_free", Linkage::Import, &sig_map_clear)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__grad_tensor_free".to_string(), grad_free_id);
    ...
    let dl_next_data_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__dataloader_next_data".to_string(), dl_next_data_id);

    // dataloader_next_labels(ptr) -> ptr — reuse sig_thread_spawn_noarg
    let dl_next_labels_id = module
        .declare_function(
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__dataloader_next_labels".to_string(), dl_next_labels_id);

    // dataloader_num_samples(ptr) -> i64 — reuse sig_thread_join
    let dl_num_id = module
        .declare_function(
    ...
    let normalize_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_normalize".to_string(), normalize_id);

    // --- S37: Model Serialization ---

    // tensor_save(ptr, ptr, i64) -> i64
    let mut sig_tsave = module.make_signature();
    ...
    let tsave_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_save".to_string(), tsave_id);

    // tensor_load(ptr, i64) -> ptr
    let mut sig_tload = module.make_signature();
    ...
    let tload_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_load".to_string(), tload_id);

    // checkpoint_save(ptr, ptr, i64, i64, i64) -> i64
    let mut sig_cksave = module.make_signature();
    ...
    let targmax_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__tensor_argmax".to_string(), targmax_id);

    // tensor_from_data(ptr, i64, i64, i64) -> ptr — 4 args, 1 return
    let mut sig_iiii_i = module.make_signature();
    sig_iiii_i
        .params
        .push(cranelift_codegen::ir::AbiParam::new(i64_ty));
    sig_iiii_i
    ...
    let rng_id = module
        ...
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__random_int".to_string(), rng_id);

    // saturating_add/sub/mul(i64, i64) -> i64 — reuse sig_tload
    let sat_add_id = module
        .declare_function("fj_rt_saturating_add", Linkage::Import, &sig_tload)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__saturating_add".to_string(), sat_add_id);
    let sat_sub_id = module
        .declare_function("fj_rt_saturating_sub", Linkage::Import, &sig_tload)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__saturating_sub".to_string(), sat_sub_id);
    let sat_mul_id = module
        .declare_function("fj_rt_saturating_mul", Linkage::Import, &sig_tload)
        .map_err(|e| CodegenError::FunctionError(e.to_string()))?;
    functions.insert("__saturating_mul".to_string(), sat_mul_id);
...
mod tests {
    ...
    use super::super::{CraneliftCompiler, ObjectCompiler};

    /// Drift gate for the shared declaration table: the AOT (ObjectCompiler)
    /// runtime surface must remain a subset of the JIT surface, and the
    /// JIT-only groups must never leak into AOT objects (they are not part
    /// of the static runtime the object backend links against).
    #[test]
    fn aot_runtime_declarations_are_subset_of_jit() {
        let mut jit = CraneliftCompiler::new().expect("jit compiler");
        jit.declare_runtime_functions().expect("jit declare");
        let mut obj = ObjectCompiler::new("parity_test").expect("object compiler");
        obj.declare_runtime_functions().expect("aot declare");

        let jit_keys: HashSet<&String> = jit.functions.keys().collect();
        let obj_keys: HashSet<&String> = obj.functions.keys().collect();
        let leaked: Vec<_> = obj_keys.difference(&jit_keys).collect();
        assert!(
            leaked.is_empty(),
            "AOT-only runtime keys appeared: {leaked:?}"
        );
        ...
        for jit_only in [
            ...
            assert!(
                jit_keys.contains(&jit_only.to_string()),
                "JIT lost {jit_only}"
            );
            assert!(
                !obj_keys.contains(&jit_only.to_string()),
                "JIT-only builtin {jit_only} leaked into the AOT surface"
            );
        }
    }
}
