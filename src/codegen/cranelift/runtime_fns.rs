...
pub fn lookup_runtime_symbol(name: &str) -> Option<*const u8> {
    match name {
        ...
        "fj_rt_bare_read_cr3" => Some(runtime_bare::fj_rt_bare_read_cr3 as *const u8),
        "fj_rt_bare_write_cr3" => Some(runtime_bare::fj_rt_bare_write_cr3 as *const u8),
        "fj_rt_bare_read_cr2" => Some(runtime_bare::fj_rt_bare_read_cr2 as *const u8),
