...
mod tests {
    ...
    // v35.7.2 (2026-05-12): Sprint DT3 tests removed alongside
    // tensor_shapes.rs deletion. See docs/TENSOR_SHAPES_LOAD_BEARING_B0_FINDINGS.md
    // and docs/decisions/2026-05-12-tensor-shapes-deletion.md.
