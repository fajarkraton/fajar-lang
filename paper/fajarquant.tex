...
\midrule
\multicolumn{4}{l}{\textit{Improvement:}} \\
$b{=}2$ & --- & $+6.3\%$ & $+4.9\%$ \\
$b{=}3$ & --- & $+3.8\%$ & $+4.3\%$ \\
$b{=}4$ & --- & $+4.0\%$ & $+4.8\%$ \\
\bottomrule
...
\midrule
Adaptive rotation (keys, $b{=}2$) & MSE vs KIVI & $+6.3\%$ \\
Adaptive rotation (keys, $b{=}3$) & MSE vs KIVI & $+3.8\%$ \\
Perplexity ($b{=}2$) & PPL (lower is better) & $\mathbf{80.1}$ \\
Perplexity ($b{=}3$) & PPL (lower is better) & $\mathbf{75.6}$ \\
Fused attention ($N{=}16$K) & Memory saved & 4~MB $\to$ 64~B \\
Hierarchical ($N{=}10$K) & Bit savings & $\mathbf{48.7\%}$ \\
...
# Rust tests (22 FajarQuant tests)
