...
|---|---|---|
| **v35.2.2** patch | 2026-05-08 | 🧹 stdlib cleanup: 109 redundant `to_int(len(...))` wrappers removed (`len()` already i64; was no-op leftover from older era). Stage 2 byte-equality preserved. → LEN_RETURNS_I64_B0_FINDINGS. |
