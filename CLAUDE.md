...
*CLAUDE.md Version: 27.5+V29.P1+V30.GEMMA3 | V30.GEMMA3 "Foundation (Path D)" 2026-04-20 — FajarOS Nova v3.6.0 Gemma 3 1B audit-complete, 12 phases PASS, research-artifact ship-readiness (pad-collapse deferred to V31 R3) | V29.P1 "Compiler Enhancement" — @noinline lexer + 5-layer silent-build-failure prevention | V27.5 "Compiler Prep" baseline — 7,626 lib + 2,575 integ + 16 V27.5 E2E + 14 doc tests, 0 flakes, 0 doc warnings, 238 examples, 0 production .unwrap(), 0 [f]/[s] modules | §6.8+§6.9 Rules*
